...
<nav id="sidebar">
        ...
        <div class="sidebar_user_info">
            ...
            <div class="user_profle_side">
                <div class="user_img"><img class="img-responsive"
                        src="<?php echo e(asset('admin/images/layout_img/user_img.jpg')); ?>" alt="#" /></div>
                <div class="user_info">
    ...
    <div class="sidebar_blog_2">
        ...
        <ul class="list-unstyled components">
            <li><a href="<?php echo e(url('/admin/dashboard')); ?>"><i class="fa fa-home" style="color:blueviolet"></i>
            ...
            <li class="active">
                ...
                <ul class="collapse list-unstyled" id="dashboard">
                    <li>
                        <a href="<?php echo e(url('/admin/category/create')); ?>">> <span>Add Category</span></a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/admin/category')); ?>">> <span>View Category</span></a>
                    </li>
                </ul>
            </li>
            <li class="active">
                ...
                <ul class="collapse list-unstyled" id="dashboard1">
                    <li>
                        <a href="<?php echo e(url('/admin/product/create')); ?>">> <span>Add Product</span></a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/admin/product')); ?>">> <span>View Product</span></a>
                    </li>
                </ul>
            </li>
            <li><a href="<?php echo e(url('/admin/brands')); ?>"><i class="fa fa-registered" style="color:lawngreen"></i>
                    <span>Brand</span></a></li>
            <li><a href="<?php echo e(url('/admin/color')); ?>"><i class="fa fa-paint-brush" style="color:yellow"></i>
...
<!-- end sidebar -->
<?php /**PATH C:\xampp\htdocs\laravelProject\resources\views/layouts/inc/admin/sidebar.blade.php ENDPATH**/ ?>